...
inline void to_json(nlohmann::json& j, const DownloadTask& t) {
    j = nlohmann::json{
        {"id", t.id}, {"bvid", t.bvid}, {"cid", t.cid}, {"aid", t.aid}, {"title", t.title},
        {"owner_name", t.owner_name}, {"cover_url", t.cover_url}, {"source_page_url", t.source_page_url},
        {"quality", t.quality}, {"quality_desc", t.quality_desc}, {"video_codec_id", t.video_codec_id},
        {"video_bandwidth", t.video_bandwidth}, {"video_width", t.video_width}, {"video_height", t.video_height},
        {"audio_id", t.audio_id}, {"audio_desc", t.audio_desc}, {"audio_codec_id", t.audio_codec_id},
        {"audio_bandwidth", t.audio_bandwidth}, {"is_dash", t.is_dash}, {"is_pgc", t.is_pgc}, {"video_urls", t.video_urls},
        {"audio_urls", t.audio_urls}, {"flv_segments", t.flv_segments}, {"status", static_cast<int>(t.status)},
        {"downloaded_bytes", t.downloaded_bytes}, {"total_bytes", t.total_bytes},
        {"audio_downloaded_bytes", t.audio_downloaded_bytes}, {"audio_total_bytes", t.audio_total_bytes},
        {"dir", t.dir}, {"video_file", t.video_file}, {"audio_file", t.audio_file},
        {"output_file", t.output_file}, {"muxed", t.muxed}, {"created_at", t.created_at}};
}
...
inline void from_json(const nlohmann::json& j, DownloadTask& t) {
    ...
    t.aid = j.value("aid", uint64_t{0}); t.title = j.value("title", ""); t.owner_name = j.value("owner_name", "");
    t.cover_url = j.value("cover_url", ""); t.source_page_url = j.value("source_page_url", "");
    t.quality = j.value("quality", 0); t.quality_desc = j.value("quality_desc", "");
    t.video_codec_id = j.value("video_codec_id", 0); t.video_bandwidth = j.value("video_bandwidth", 0u);
    t.video_width = j.value("video_width", 0); t.video_height = j.value("video_height", 0);
    t.audio_id = j.value("audio_id", 0); t.audio_desc = j.value("audio_desc", "");
    t.audio_codec_id = j.value("audio_codec_id", 0); t.audio_bandwidth = j.value("audio_bandwidth", 0u);
    t.is_dash = j.value("is_dash", false); t.is_pgc = j.value("is_pgc", false);
    t.video_urls = j.value("video_urls", std::vector<std::string>{});
    t.audio_urls = j.value("audio_urls", std::vector<std::string>{}); t.flv_segments = j.value("flv_segments", std::vector<FlvSegment>{});
    t.status = static_cast<DownloadTaskStatus>(j.value("status", 0)); t.downloaded_bytes = j.value("downloaded_bytes", int64_t{0});
    t.total_bytes = j.value("total_bytes", int64_t{0}); t.audio_downloaded_bytes = j.value("audio_downloaded_bytes", int64_t{0});
    ...
    t.created_at = j.value("created_at", int64_t{0});
